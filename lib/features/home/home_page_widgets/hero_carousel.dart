...
class _HeroCarouselState extends State<HeroCarousel> {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.asyncData.when(
      ...
      error: (err, _) {
        return _DefaultHero(isTimeout: err is TimeoutException);
      },
    );
  }
}
...
class _CarouselItemCard extends StatelessWidget {
  ...
  const _CarouselItemCard({required this.item, required this.index});
  ...
  Widget build(BuildContext context) {
    ...
    final String title =
        ...
        item['title']?['romaji'] ??
        'Unknown Title';
    final List<dynamic>? genres = item['genres'] as List<dynamic>?;
    ...
    return GestureDetector(
      ...
      child: Stack(
        ...
        children: [
          ...
          const _GradientOverlay(), // Reused constant overlay
          Positioned(
            bottom: 50,
            left: 20,
            right: 20,
              ...
              children: [
                ...
                if (genres != null && genres.isNotEmpty)
                  Wrap(
                    ...
                    spacing: 8,
                    children: genres.take(3).map<Widget>((g) {
                      return Text(
                        '• $g',
                        style: const TextStyle(
