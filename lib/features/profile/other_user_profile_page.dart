...
import 'package:otakulink/features/profile/profile_tabs/library_tab.dart';
import 'package:otakulink/features/profile/profile_tabs/overview_tab.dart';
import 'package:otakulink/features/profile/profile_tabs/reviews_tab.dart';
import 'package:otakulink/features/profile/profile_widgets/follows_you_badge.dart';
...
class OtherUserProfilePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final profileAsyncValue = ref.watch(
      userProfileStreamProvider(targetUserId),
    );
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () =>
                ref.invalidate(userProfileStreamProvider(targetUserId)),
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          ref.invalidate(userProfileStreamProvider(targetUserId));
          await ref.read(userProfileStreamProvider(targetUserId).future);
        },
