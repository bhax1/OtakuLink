...
import 'package:otakulink/features/profile/profile_widgets/library_filter_modal.dart';
import 'package:otakulink/features/profile/domain/entities/profile_entities.dart';

class LibraryTab extends ConsumerStatefulWidget {
  final String userId;
  const LibraryTab({super.key, required this.userId});
...
class _LibraryTabState extends ConsumerState<LibraryTab>
        ...
        Expanded(
          child: StreamBuilder<List<LibraryEntryEntity>>(
            ...
            builder: (context, snapshot) {
              ...
              final totalDocsFetched = snapshot.data!.length;
              var displayList = snapshot.data!.where((doc) {
  ...
  Widget _buildLibraryItem(
    ...
    LibraryEntryEntity doc,
    bool isDataSaver,
  ) {
    final theme = Theme.of(context);
    final id = doc.mangaId;
    final title = doc.title;
    final image = doc.imageUrl;
    final rating = doc.rating;
    final isFav = doc.isFavorite;
