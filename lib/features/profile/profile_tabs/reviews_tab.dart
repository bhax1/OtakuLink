  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<LibraryEntryEntity>>(
      ...
      builder: (context, snapshot) {
        ...
        final totalDocsFetched = reviewsData.length;
        final reviewDocs = reviewsData.where((doc) {
          final comment = doc.commentary;
