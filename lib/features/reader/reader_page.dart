...
import 'package:otakulink/features/reader/providers/reader_state.dart';
...
class _ReaderPageState extends ConsumerState<ReaderPage> {
  ...
  void _showChapterDiscussion() {
    final readerState = ref.read(readerControllerProvider);
    final currentChapter = widget.allChapters[readerState.currentIndex];

    // mangaId in ReaderPage is String, but DiscussionPage expects int
    final mId = int.tryParse(widget.mangaId) ?? 0;

    context.push(
      '/manga/$mId/discussion',
      extra: {
        'mangaId': mId,
        'mangaName': widget.mangaTitle,
        'chapterId': currentChapter['id'],
        'chapterNumber': currentChapter['chapter']?.toString(),
      },
    );
  }
      ...
      child: NotificationListener<ScrollNotification>(
        onNotification: (ScrollNotification scrollInfo) {
          ...
          _debounceTimer = Timer(const Duration(milliseconds: 500), () {
            ref
                .read(readerControllerProvider.notifier)
                .saveProgress(verticalPixels: pixels);
          });
        ...
        body: Stack(
          children: [
            ...
            ReaderTopBar(
              ...
              onDiscussionTap: _showChapterDiscussion,
            ),
